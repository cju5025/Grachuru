...
const Colour GrachuruColour_1 = Colour(0, 0, 0).withAlpha(0.0f);
const Colour GrachuruColour_2 = Colour(0, 0, 0).withAlpha(0.3f);
const Colour GrachuruColour_3 = Colour(0, 0, 0).withAlpha(0.6f);
const Colour GrachuruColour_4 = Colour(0, 0, 0).withAlpha(0.8f);
const Colour GrachuruColour_5 = Colour(105, 105, 105);
const Colour GrachuruColour_6 = Colour(105, 105, 105).withAlpha(0.3f);
const Colour GrachuruColour_7 = Colour(125, 125, 125);
